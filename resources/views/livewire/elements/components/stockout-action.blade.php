<div class="">
    <a href="#" class="x-button text-danger"
        onclick="event.preventDefault(); Livewire.emit('modal', 'delete', '{{ $component->id }}', 'Xoá dữ liệu', 'danger','fas fa-trash')">
    ...
    <a href="#" class="x-button text-danger"
        onclick="event.preventDefault(); Livewire.emit('modal', 'restock','{{ $component->id }}', 'Thông tin chi tiết', 'success','fas fa-danger-arrival')">
