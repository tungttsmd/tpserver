            ...
            <div class="col-lg-10">
                <div class="card shadow-lg rounded-4">
                    ...
                    <div style="height: 200px; background-size: cover; background-position: center;"
                        @if ($user->cover_url) style="background-image: url('{{ asset($user->cover_url) }}');"
                     @else
                     style="background-color: #ddd;" @endif>
                    </div>
                        ...
                        <div class="row align-items-center g-4">
                            ...
                            <div class="col-md-3 text-center">
                                <img src="{{ asset($user->avatar_url) }}"
                                    ...
                                    style="width: 200px; height: 200px; object-fit: cover; margin-top: -100px; border: 5px solid white; border-radius: 50%;">
                            ...
                            {{ $user->canEditUser() ? 'justify-content-between' : 'justify-content-end' }}">
                                ...
                                @if ($user->canEditUser())
                                    <div class="d-flex flex-wrap gap">
                                        <a href="{{ route('profile.edit-avatar', $user->id) }}"
                                            class="btn btn-outline-info">
                                            <i class="fas fa-image mr-2"></i> Đổi avatar
                                        </a>

                                        <a href="{{ route('profile.edit-alias', $user->id) }}"
                                            class="btn btn-outline-primary">
                                            <i class="fas fa-user-edit mr-2"></i> Sửa alias
                                        </a>
                                        @if ($user->canEditPassword())
                                            <a href="{{ route('profile.edit-password', $user->id) }}"
