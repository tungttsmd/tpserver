<div class="">
    ...
    <a href="#" class="x-button text-success"
        onclick="event.preventDefault(); Livewire.emit('componentId', {{ $componentId }}); Livewire.emit('modal', 'stockout','{{ $componentId }}', 'Lý do xuất kho', 'success','fas fa-plane-departure')">
