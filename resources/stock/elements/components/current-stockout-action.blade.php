<div class="">
    ...
    <a href="#" class="x-button text-danger"
        onclick="event.preventDefault();Livewire.emit('componentId', {{ $component->id }}); Livewire.emit('modal', 'stockreturn','{{ $component->id }}', 'Lý do thu hồi', 'danger','fas fa-plane-arrival')">
