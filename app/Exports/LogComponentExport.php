...
class LogComponentExport implements FromCollection, WithMapping, WithHeadings
{
    /**
    ...
    {
        return LogComponent::with(['user', 'action'])->select('id', 'user_id', 'action_id', 'note', 'updated_at', 'created_at')->get();
    }
